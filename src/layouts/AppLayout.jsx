...
export const AppLayout = () => {
  ...
  return (
    <>
      ...
      <div
        ref={sidebarRef}
        className={`fixed top-[60px] h-[calc(100%-60px)] bg-[#684328] text-white z-40 shadow-lg pt-4
          w-64 transition-transform duration-300 ease-in-out transform
          ${
            isSidebarOpen
              ? "translate-x-0"
              : "-translate-x-full"
      ...
      {/* Content Wrapper: Push content right on desktop */}
      <div
