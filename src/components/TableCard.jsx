  ...
  return (
    <div className="glass bg-white/20 backdrop-blur-md border border-white/10 rounded-xl shadow-xl p-5 transition 
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <span
          className={`px-3 py-1 rounded-full text-xs font-semibold shadow-md border border-white/10 backdrop-blur-sm ${statusStyle}`}
        >
          {statusText}
        </span>
      </div>
      ...
      {isAvailable && (
        <button
          ...
          className="w-full py-2 mt-1 bg-yellow-300 hover:bg-yellow-400 active:bg-yellow-400 text-black font-bold rounded-lg 
